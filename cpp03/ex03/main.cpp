...
/*   Updated: 2023/01/06 18:01:06 by hoomen           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void testFragTrap() {
  ...
  std::cout << "\033[1;33m ---String constructor for FragTrap b (\"Dave\")---\033[0m\n";
  FragTrap b("Dave");
  ...
  for (int i = 0; i < 101; i++)
    b.attack("Gary");
  b.beRepaired(3);
  std::cout << "\033[1;33m ---Copy constructor for FragTrap c (copy form FragTrap b)---\033[0m\n";
  FragTrap c(b);
...
void testDiamondTrap() {
  ...
  std::cout << "\033[1;33m ---String constructor for DiamondTrap a (\"Katy\")---\033[0m\n";
  DiamondTrap a("Katy");
  ...
  a.takeDamage(16);
  a.beRepaired(1);
  std::cout << "\033[1;33m ---Copy constructor for DiamondTrap b, copied from DiamondTrap a---\033[0m\n";
  DiamondTrap b(a);
  ...
  b.takeDamage(5);
  b.beRepaired(1);
  std::cout << "\033[1;33m ---Default constructor for DiamondTrap c---\033[0m\n";
  DiamondTrap c;
  c.whoAmI();
  c.attack("Tammy");
  c.takeDamage(13);
  std::cout << "\033[1;33m ---Copy assignment operator, assign DiamondTrap b to DiamondTrap c---\033[0m\n";
  c = b;
