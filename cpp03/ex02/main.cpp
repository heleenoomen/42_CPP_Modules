...
/*   Updated: 2022/12/08 12:33:47 by hoomen           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main() {
  ...
  std::cout<<"\033[48:5:208m -----### TESTING CLAPTRAP ###-----\033[0m"<<std::endl;
  {
  ...
  std::cout<<std::endl;
  std::cout<<"\033[48:5:208m -----### TESTING SCAVTRAP ###-----\033[0m"<<std::endl;
  {
	std::cout<<"\033[1;33m ---Default constructor---\033[0m"<<std::endl;
  ScavTrap a;
	std::cout<<"\033[1;33m ---String constructor---\033[0m"<<std::endl;
  ...
  std::cout<<std::endl;
  std::cout<<"\033[48:5:208m -----### TESTING FRAGTRAP ###-----\033[0m"<<std::endl;
  {
    std::cout<<"\033[1;33m ---Default constructor---\033[0m"<<std::endl;
    FragTrap a;
    std::cout<<"\033[1;33m ---String constructor---\033[0m"<<std::endl;
