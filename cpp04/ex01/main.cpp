...
/*   Updated: 2023/01/08 17:09:31 by hoomen           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main() {
            ...
            << std::endl;
  {
    ...
    *dog2 = *dog1;
    ...
    cat1->setIdea(2, "my hoooooman left the kitchen, gotta steal cheese now");
    cat1->setIdea(3, "Mouse? Was that a mouse?");
    cat1->setIdea(4, "More food please!");
